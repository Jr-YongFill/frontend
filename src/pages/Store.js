    ...
    <>
      ...
      <Wrapper>
        ...
        <div>
          <GlassCard>
            <Title>
              <h1>Stack 상점</h1>
              <h1 onClick={() => setCreditInfoModal(true)}>
                {" "}
                <FontAwesomeIcon icon={faCircleInfo} style={{cursor:"pointer"}}/>   내 크레딧: {credit}
              </h1>
            </Title>
            <Main>
              <Content>
                {stacks &&
                  stacks.map((stack, idx) => {
                    return (
                      <CustomButton
                        key={idx}
                        color={stack.isPurchase ? palette.purple : palette.dark}
                        onClick={() => {
                          setModalSwitch(true);
              ...
              >
                ...
                {memberRole === "ADMIN" && (
                  <CustomButton onClick={() => setModalAdminSwitch(true)}>
                    스택 생성
                  </CustomButton>
                )}
              </div>
      ...
      >
        <ModalContent>
          ...
          />
          <CustomButton onClick={() => fetchInitStack()}>생성</CustomButton>
        </ModalContent>
      </GlassModalChildren>
      <GlassModalChildren
      ...
      >
        <ModalContent>
          ...
          <StackDescriptInput
            ...
            style={{ marginBottom: "20px" }}
          />
          <CustomButton onClick={() => fetchUpdateStack(modalStack.id)}>
            수정
          </CustomButton>
        </ModalContent>
      </GlassModalChildren>
